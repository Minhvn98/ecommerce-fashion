...
CREATE TABLE `orders` (
  ...
  `status` enum('Chờ thanh toán','Đang vận chuyển','Đã thanh toán','Giao hàng thành công','Đã hủy đơn hàng') COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `users` (
  ...
  `role` enum('admin','customer') COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
...
-- Dump completed on 2021-07-09  2:34:05
